...
O sistema simula um cenário real de aprovação de solicitações com base em valor e tipo, seguindo regras de negócio previamente definidas.
...
- Tipos de solicitação são validados
- Entradas inválidas não quebram o sistema
- O fluxo permanece ativo até a entrada correta
